...
import { ColorSwitch, DarkModeSwitch } from '../components/index'
    ...
    >
        ...
        <Table style={{ color: 'inherit', width: '100%' }}>
            ...
            <tbody>
                ...
                <tr>
                    <td><code>lightModeColor</code></td>
                    <td><code>string</code></td>
                    <td>The color of the sun when in light mode.<br />By default set to <code>rgba(18, 18, 18, .8)</code>.</td>
                </tr>
                <tr>
                    <td><code>darkModeColor</code></td>
                    <td><code>string</code></td>
                    <td>The color of the moon when in dark mode.<br />By default set to <code>rgba(255, 255, 255, .87)</code>.</td>
                </tr>
                <tr>
                    <td><code>size</code></td>
                    <td><code>number</code></td>
                ...
                <tr>
                    <td><code>animDuration</code></td>
                    <td><code>string</code></td>
                    <td>How long the animation to change between sun/moon should take.<br />By default set to <code>.4s</code>.</td>
                </tr>
                <tr>
                    <td><code>onClick</code></td>
                    <td><code>function</code></td>
                    <td>Runs code when button clicked. By default changes component's internal <code>darkMode</code> value. Though named <code>onClick</code>, the prop is screenreader and keyboard compatible.</td>
                </tr>
                <tr>
                    <td><code>...rest</code></td>
                    <td><code>any</code></td>
